...
kustomize build manifests/weave/${networkName}/bns | sed 's/weave_placeholder/bns/' | kubectl apply -f -
#kustomize build manifests/weave/${networkName} /bcp | sed 's/weave_placeholder/bcp/' | kubectl apply -f -
